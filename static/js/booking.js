...
fetch(url, {
  ...
  .then((result) => {
    if (result.data) {
      ...
      info_image.setAttribute(
        "src",
        info_data.attraction.image
          ? info_data.attraction.image
      ...
      // main.innerHTML = ""
      let visibleDivs = document.querySelectorAll(
        ".main div:not(.main_title, .main_info)"
      );
...
TPDirect.setupSDK(
  137080,
  "app_VsPZEH9GV2oGxdW1bDlwPrHYETtpZPbgsqCYSojzEnAyGSMzceRMz8bPJFM8",
  "sandbox"
);
